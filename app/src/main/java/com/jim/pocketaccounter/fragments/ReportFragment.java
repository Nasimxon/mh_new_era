...
public class ReportFragment extends Fragment {
    ...
    private class PercentSubcategoryAdapter extends RecyclerView.Adapter<ReportFragment.ViewHolder> {
        ...
        public void onBindViewHolder(final ReportFragment.ViewHolder view, final int position) {
        ...
        public ReportFragment.ViewHolder onCreateViewHolder(ViewGroup parent, int var2) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_by_category_percent_subcats_item, parent, false);
            return new ReportFragment.ViewHolder(view);
        }
    }
    ...
    private class PercentSubcategoryDetailAdapter extends RecyclerView.Adapter<ReportFragment.DetailedViewHolder> {
        ...
        public void onBindViewHolder(final ReportFragment.DetailedViewHolder view, final int position) {
        ...
        public ReportFragment.DetailedViewHolder onCreateViewHolder(ViewGroup parent, int var2) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_by_category_detail_list_item, parent, false);
            return new ReportFragment.DetailedViewHolder(view);
        }
    }
