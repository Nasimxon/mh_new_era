            ...
            public boolean onPreferenceClick(final Preference preference) {
                ...
                builder.setMessage(R.string.default_settings)
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        keys.put(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.DARK_BLUE, sharedPreferences.getBoolean(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.YELLOW_THEME, false));
                        keys.put(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.LIGHT_BLUE, sharedPreferences.getBoolean(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.YELLOW_THEME, false));
                        keys.put(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.RED_LIPS, sharedPreferences.getBoolean(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.YELLOW_THEME, false));
                        keys.put(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.GREEN_THEME, sharedPreferences.getBoolean(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.YELLOW_THEME, false));
                        keys.put(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.ORANGE_THEME, sharedPreferences.getBoolean(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.YELLOW_THEME, false));
                        keys.put(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.LIGHT_YELLOW, sharedPreferences.getBoolean(PocketAccounterGeneral.MoneyHolderSkus.SkuPreferenceKeys.YELLOW_THEME, false));
