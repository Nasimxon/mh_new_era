...
public class CurrencyCalcAdapter extends BaseAdapter {
    Context context;
    ArrayList objects;
    ArrayList objects2;

    public CurrencyCalcAdapter(Context context, ArrayList strings1 ,ArrayList strings2) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        View customSpinner = LayoutInflater.from(parent.getContext()).inflate(R.layout.spinner_single_item_calc, parent, false);
