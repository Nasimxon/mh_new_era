...
public class BuyRecognizeDialog extends Dialog {
    private TextView tv;
    private TextView title;
    View dialogView;
    public BuyRecognizeDialog(Context context) {
        super(context);
    ...
    public BuyRecognizeDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected BuyRecognizeDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
